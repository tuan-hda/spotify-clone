    ...
    <>
      <div className='min-h-full bg-transparent bg-s-black-10 px-8 pt-20'>
        ...
        <div className='autofill mt-4 grid gap-6'>
          <div className='col-span-2 flex flex-col justify-end rounded-lg bg-gradient-to-br from-s-purple-1 to-s-purple-2 pl-5 pb-5'>
          ...
          {data?.body.items.map((item) => {
            if (item) return <ListItem shadowFallback={false} key={item.id} item={item} />
          })}
        </div>
      </div>
    </>
